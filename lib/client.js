  ...
  factory: (require) => {
    ...
    const setPrefs = (patch) => {
      ...
      if (patch.dockPlacement !== undefined && patch.dockPlacement !== prefsStore.dockPlacement) {
        ...
        // its localStorage mirror, and that mirror is the shared placement
        // source every consumer reads.
    ...
    const plugin = {
      apply(ctx) {
        ...
        // other panels' geometry reads follow). A separate inject call, so
